...
public:
	...
	// Evaluating clock pixck

	// sim_pixck_tick() will be called from TESTB<Vmain>::tick()
	//   following any falling edge of clock pixck
	virtual	void	sim_pixck_tick(void) {
		//
		// SIM.TICK tags go here for SIM.CLOCK=pixck
		//
	...
	//
	// Step until clock pixck ticks
	//
	virtual	void	tick_pixck(void) {
		do {
			tick();
