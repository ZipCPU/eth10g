...
`endif
		...
		w_sdio_debug | (w_sdio_hwreset_n ? 32'h0 : 32'h020000),
		...
		w_emmc_debug | (w_emmc_hwreset_n ? 32'h0 : 32'h020000),
		// SDSLAVE
		w_sdslav_clk,
		w_sdslav_tx_cmd,
		w_sdslav_cmd_tristate,
...
`endif
	...
	sdfrontend #(
		...
		//
		.i_ac_reset_n(w_sdio_ac_reset_n),
...
`endif
	...
	sdfrontend #(
		...
		//
		.i_ac_reset_n(w_emmc_ac_reset_n),
