...
`endif
	...
	// }}}
	// 10Gb Ethernet
	wire				i_clk_156mhz_p, i_clk_156mhz_n;
	wire	[4-1:0]		gnet_rx_clk, gnet_tx_clk;
	wire	[4-1:0]		gnet_rx_valid, gnet_tx_ready;
	...
	main	thedesign(s_clk, s_reset,
		...
		i_i2c_sda, i_i2c_scl,
		o_i2c_sda, o_i2c_scl,
		gnet_rx_clk, gnet_rx_valid, gnet_rx_data,
		gnet_tx_clk, gnet_tx_ready, gnet_tx_data,
...
*/
	...
	*/
	...
	xgtxphy #(
		...
		//
		.S_CLK(  gnet_tx_clk),
		.S_READY(gnet_tx_ready),
		.S_DATA( gnet_tx_data),
		//
		.M_CLK(  gnet_rx_clk),
		.M_VALID(gnet_rx_valid),
		.M_DATA( gnet_rx_data),
		//
