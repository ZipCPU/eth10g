...
// }}}
	...
	wire	[9:0]	wb32_sirefclkcounter_addr;
...
`endif	// BKRAM_ACCESS
	...
	4'h7: r_wb32_sio_data <= wb32_siclk_idata;
	4'h8: r_wb32_sio_data <= wb32_sirefclk_idata;
	4'h9: r_wb32_sio_data <= wb32_sirefclkcounter_idata;
	...
	assign	wb32_siclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h7);  // 0x01c
	...
	assign	wb32_sirefclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h8);  // 0x020
	...
	assign	wb32_sirefclkcounter_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h9);  // 0x024
...
`endif	// NETSTAT_ACCESS
	...
	//
	wbxbar #(
		.NM(1), .NS(19), .AW(10), .DW(32),
		.SLAVE_ADDR({
			// Address width    = 10
			// Address LSBs     = 2
			{ 10'h200 }, //   netstats: 0x800
			{ 10'h180 }, //   ddr3_phy: 0x600
			{ 10'h100 }, //       gnet: 0x400
			{ 10'h0c0 }, //   wb32_dio: 0x300
			{ 10'h0a0 }, //     cpunet: 0x280
			{ 10'h080 }, //        cfg: 0x200
			{ 10'h060 }, //       sdio: 0x180
			{ 10'h058 }, //        fan: 0x160
			{ 10'h050 }, //       emmc: 0x140
			{ 10'h048 }, //       uart: 0x120
			{ 10'h040 }, //  sdioscope: 0x100
			{ 10'h038 }, // routescope: 0x0e0
			{ 10'h030 }, //   netscope: 0x0c0
			{ 10'h028 }, //   i2cscope: 0x0a0
			{ 10'h020 }, //  gatescope: 0x080
			{ 10'h018 }, //   flashdbg: 0x060
			{ 10'h010 }, //  emmcscope: 0x040
			{ 10'h008 }, //   busscope: 0x020
