...
// }}}
	...
	//
	wire	scope_smi_int;	// scope_smi.INT.SDSCOPE.WIRE
...
//
	...
	assign	wbflash_wbflashdn_err = wbflash_flash_err;
...
`else	// SMISCOPE_SCOPC
	...
	// {{{
	assign	scope_smi_int = 1'b0;	// scope_smi.INT.SDSCOPE.WIRE
	// }}}
	// }}}
...
`endif	// SMI_CONSOLE
	...
	wbdown #(
		...
		.i_waddr( wbwide_wbdown_addr[2-1:0]),
		...
		.o_saddr( wb32_wbdown_addr[6-1:0]),
