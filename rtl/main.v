...
// }}}
	...
	//
	wire	rxedidscope_int;	// rxedidscope.INT.RXEDIDSCOPE.WIRE
...
// }}}
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component rxedidscope
	// Verilator lint_off UNUSED
	wire		wb32_rxedidscope_cyc, wb32_rxedidscope_stb, wb32_rxedidscope_we;
	wire	[10:0]	wb32_rxedidscope_addr;
	wire	[31:0]	wb32_rxedidscope_data;
	wire	[3:0]	wb32_rxedidscope_sel;
	wire		wb32_rxedidscope_stall, wb32_rxedidscope_ack, wb32_rxedidscope_err;
	wire	[31:0]	wb32_rxedidscope_idata;
	// Verilator lint_on UNUSED
	...
	assign	wb32_rxedidscope_err= 1'b0;
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 11'h100 }, //        uart: 0x0400
			{ 11'h0c0 }, // rxedidscope: 0x0300
			{ 11'h080 }, //    netscope: 0x0200
			{ 11'h040 }, //    i2cscope: 0x0100
			{ 11'h000 }  //   emmcscope: 0x0000
		}),
		.SLAVE_MASK({
			// Address width    = 11
			// Address LSBs     = 2
...
`ifdef	RXEDIDSCOPE_SCOPC
	...
	wbscopc #(
		...
		// {{{
		i_clk, 1'b1, edid_debug[31], edid_debug[30:0],
		i_clk,
		wb32_rxedidscope_cyc, wb32_rxedidscope_stb, wb32_rxedidscope_we,
			wb32_rxedidscope_addr[1-1:0],
			wb32_rxedidscope_data, // 32 bits wide
			wb32_rxedidscope_sel,  // 32/8 bits wide
		wb32_rxedidscope_stall, wb32_rxedidscope_ack, wb32_rxedidscope_idata,
		rxedidscope_int
		// }}}
	);
	// }}}
`else	// RXEDIDSCOPE_SCOPC
	// {{{
	// Null bus slave
	// {{{

	//
	// In the case that there is no wb32_rxedidscope peripheral
	// responding on the wb32 bus
	assign	wb32_rxedidscope_ack   = 1'b0;
	assign	wb32_rxedidscope_err   = (wb32_rxedidscope_stb);
	assign	wb32_rxedidscope_stall = 0;
	assign	wb32_rxedidscope_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	rxedidscope_int = 1'b0;	// rxedidscope.INT.RXEDIDSCOPE.WIRE
	// }}}
	// }}}
`endif	// RXEDIDSCOPE_SCOPC
...
`ifdef	VIDPIPE_ACCESS
	...
	vidpipe #(
		...
		.o_dma_cyc(wbwide_hdmi_cyc), .o_dma_stb(wbwide_hdmi_stb), .o_dma_we(wbwide_hdmi_we),
			.o_dma_addr(wbwide_hdmi_addr[14-1:0]),
