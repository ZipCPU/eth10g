...
// Unmet Dependency list for @$(PREFIX)=satatxck
`ifdef	SATA_ACCESS // This value is unknown
`define	SATATXCOUNTER_ACCESS
`endif

// Unmet Dependency list for @$(PREFIX)=satapscope
`ifdef	SATA_ACCESS // This value is unknown
`define	SATAPSCOPE_SCOPC
`endif

// Unmet Dependency list for @$(PREFIX)=satarefcounter
`ifdef	SATA_ACCESS // This value is unknown
`define	SATAREFCOUNTER_ACCESS
`endif

// Unmet Dependency list for @$(PREFIX)=satalscope
`ifdef	SATA_ACCESS // This value is unknown
`define	SATALSCOPE_SCOPC
`endif

// Unmet Dependency list for @$(PREFIX)=satarscope
`ifdef	SATA_ACCESS // This value is unknown
`define	SATARSCOPE_SCOPC
`endif

// Unmet Dependency list for @$(PREFIX)=satarxck
`ifdef	SATA_ACCESS // This value is unknown
`define	SATARXCOUNTER_ACCESS
`endif

// Unmet Dependency list for @$(PREFIX)=satatscope
`ifdef	SATA_ACCESS // This value is unknown
...
// }}}
	...
	wire	[8:0]	wb32_satarefcounter_addr;
...
`endif	// NETSTAT_ACCESS
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 9'h038 }, //       emmc: 0x0e0
			{ 9'h030 }, //       uart: 0x0c0
			{ 9'h02c }, //  sdioscope: 0x0b0
			{ 9'h028 }, // satatscope: 0x0a0
			{ 9'h024 }, // satarscope: 0x090
			{ 9'h020 }, // satapscope: 0x080
			{ 9'h01c }, // satalscope: 0x070
			{ 9'h018 }, // routescope: 0x060
			{ 9'h014 }, //   netscope: 0x050
			{ 9'h010 }, //   i2cscope: 0x040
			{ 9'h00c }, //  gatescope: 0x030
			{ 9'h008 }, //   flashdbg: 0x020
			{ 9'h004 }, //  emmcscope: 0x010
			{ 9'h000 }  //   flashcfg: 0x000
		}),
		.SLAVE_MASK({
			// Address width    = 9
			// Address LSBs     = 2
