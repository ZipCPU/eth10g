...
`endif
		...
		o_flash_cs_n, o_flash_sck, o_flash_dat, i_flash_dat, o_flash_mod,
			i_i2c_sda, i_i2c_scl,
			o_i2c_sda, o_i2c_scl,
		i_gnet_rx_clk, i_gnet_rx_valid,i_gnet_rx_data,
		i_gnet_tx_clk, i_gnet_tx_ready,o_gnet_tx_data,
...
`endif
	...
	input	wire	[4-1:0]	i_gnet_rx_clk,
					i_gnet_rx_valid;
	input	wire [66*4-1:0]	i_gnet_rx_data;
	input	wire	[4-1:0]	i_gnet_tx_clk,
					i_gnet_tx_ready;
	output	wire [66*4-1:0]	o_gnet_tx_data;
...
// }}}
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 7'h20 }, //    i2cdma: 0x080
			{ 7'h1c }, //       i2c: 0x070
			{ 7'h18 }, // sdioscope: 0x060
			{ 7'h14 }, // scope_smi: 0x050
			{ 7'h10 }, //  i2cscope: 0x040
			{ 7'h0c }, //  flashdbg: 0x030
			{ 7'h08 }, //  fanscope: 0x020
			{ 7'h04 }, //  cfgscope: 0x010
...
`ifdef	ETH_ROUTER
	...
	begin : GEN_ETHERNET_DECODE
		...
		u_netpath (
			...
			.i_raw_valid(i_gnet_rx_valid[g_gnet]),
			.i_raw_data(i_gnet_rx_data[66*g_gnet+:66]),
			//
			.i_raw_ready(i_gnet_tx_ready[g_gnet]),
			.o_raw_data(o_gnet_tx_data[66*g_gnet+:66]),
			// }}}
	...
	routecore #(
		...
		.o_vfifo_cyc(wbwide_gnet_cyc), .o_vfifo_stb(wbwide_gnet_stb), .o_vfifo_we(wbwide_gnet_we),
			.o_vfifo_addr(wbwide_gnet_addr[20-1:0]),
