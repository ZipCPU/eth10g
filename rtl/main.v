...
`ifdef	BUSCONSOLE_ACCESS
	...
	wbconsole #(.LGFLEN(6)
		...
		// {{{
		i_clk, 1'b0,
		wb32_uart_cyc, wb32_uart_stb, wb32_uart_we,
			wb32_uart_addr[2-1:0],
			wb32_uart_data, // 32 bits wide
			wb32_uart_sel,  // 32/8 bits wide
		wb32_uart_stall, wb32_uart_ack, wb32_uart_idata,
...
`ifdef	GPIO_ACCESS
	...
	//
	localparam [NGPO-1:0]	INITIAL_GPIO = 5'h0;
