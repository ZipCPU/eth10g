...
// }}}
	...
	assign	wb32_netreset_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h4);  // 0x10
	...
	assign	wb32_siclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h5);  // 0x14
	...
	assign	wb32_sirefclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h6);  // 0x18
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 8'h60 }, //   cpunet: 0x180
			{ 8'h40 }, //      cfg: 0x100
			{ 8'h30 }, // wb32_sio: 0x0c0
			{ 8'h20 }, //     gnet: 0x080
			{ 8'h10 }, //      fan: 0x040
			{ 8'h0c }, //     uart: 0x030
			{ 8'h08 }, //   i2cdma: 0x020
			{ 8'h04 }, //      i2c: 0x010
			{ 8'h00 }  // netscope: 0x000
		}),
		.SLAVE_MASK({
			// Address width    = 8
			// Address LSBs     = 2
