...
//
// CmdLine:	autofpga -I .: -d -o . allclocks.txt siclk.txt sirefclk.txt global.txt wbdown.txt icape.txt version.txt pwrcount.txt rtccount.txt gpio.txt spio.txt wbuconsole.txt zipmaster.txt bkram.txt ddr3.txt flash.txt swload.txt sdio.txt emmc.txt sdslave.txt sata.txt netrouter.txt cpunet.txt netstats.txt scopepic.txt i2cscope.txt zipscope.txt emmcscope.txt satascope.txt routescope.txt netscope.txt gatescope.txt mem_bkram_only.txt mem_sdram_only.txt mem_flash_bkram.txt mem_full.txt i2ccpu.txt fan.txt sirefclkcounter.txt netclk.txt
//
...
`else
`ifdef	FLASH_ACCESS
	localparam	RESET_ADDRESS = 119537664;
`else
	localparam	RESET_ADDRESS = 67108864;
`endif	// FLASH_ACCESS
`endif	// BKROM_ACCESS
`ifdef	DDR3_CONTROLLER_ACCESS
	localparam	CPU_BOOTRAM = 31'h40000000;
`else
`ifdef	SDRAM_ACCESS
	localparam	CPU_BOOTRAM = 31'h@$[%08x](sdram.REGBASE);
`else
	localparam	CPU_BOOTRAM = 31'h04000000;
`endif
`endif
	//
...
`endif
	...
	output	wire	[39:0]	o_sdio_cfg_phy_trim;
	...
	output	wire	[39:0]	o_emmc_cfg_phy_trim;
...
// }}}
	...
	wire	w_scope_int;	// scopepic.INT.SCOPE.WIRE
...
// }}}
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32(SIO), component scopepic
	// Verilator lint_off UNUSED
	wire		wb32_scopepic_cyc, wb32_scopepic_stb, wb32_scopepic_we;
	wire	[10:0]	wb32_scopepic_addr;
	wire	[31:0]	wb32_scopepic_data;
	wire	[3:0]	wb32_scopepic_sel;
	wire		wb32_scopepic_stall, wb32_scopepic_ack, wb32_scopepic_err;
	wire	[31:0]	wb32_scopepic_idata;
	// Verilator lint_on UNUSED
...
`endif	// BKRAM_ACCESS
	...
	4'ha: r_wb32_sio_data <= wb32_scopepic_idata;
	4'hb: r_wb32_sio_data <= wb32_siclk_idata;
	4'hc: r_wb32_sio_data <= wb32_sirefclk_idata;
	4'hd: r_wb32_sio_data <= wb32_sirefclkcounter_idata;
	4'he: r_wb32_sio_data <= wb32_spio_idata;
	4'hf: r_wb32_sio_data <= wb32_version_idata;
	// No default: SIZE = 16, [Guru meditation: 4 != 4]
	endcase
	...
	assign	wb32_scopepic_cyc = wb32_sio_cyc;
	assign	wb32_scopepic_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'ha);  // 0x028
	assign	wb32_scopepic_we  = wb32_sio_we;
	assign	wb32_scopepic_data= wb32_sio_data;
	assign	wb32_scopepic_sel = wb32_sio_sel;
	assign	wb32_siclk_cyc = wb32_sio_cyc;
	assign	wb32_siclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'hb);  // 0x02c
	...
	assign	wb32_sirefclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'hc);  // 0x030
	...
	assign	wb32_sirefclkcounter_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'hd);  // 0x034
	...
	assign	wb32_spio_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'he);  // 0x038
	...
	assign	wb32_version_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'hf);  // 0x03c
...
`endif	// NETSTAT_ACCESS
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 11'h0c0 }, // satadrpscope: 0x0300
			{ 11'h0a0 }, //   routescope: 0x0280
			{ 11'h080 }, //     netscope: 0x0200
			{ 11'h060 }, //     i2cscope: 0x0180
			{ 11'h040 }, //    gatescope: 0x0100
			{ 11'h020 }, //    emmcscope: 0x0080
...
`ifdef	NETCLK_ACCESS
	...
	begin
		...
		else if (wb32_netclk_addr[2:0] == 3'h5)
...
`ifdef	SCOPEPIC_ACCESS
	...
	u_scopepic (
		...
		.i_wb_cyc(wb32_scopepic_cyc), .i_wb_stb(wb32_scopepic_stb), .i_wb_we(wb32_scopepic_we),
			.i_wb_data(wb32_scopepic_data), // 32 bits wide
...
`else	// SCOPEPIC_ACCESS
	...
	// Null interrupt definitions
	// {{{
	assign	w_scope_int = 1'b0;	// scopepic.INT.SCOPE.WIRE
	// }}}
	// }}}
...
`endif
		...
		.i_wb_cyc(wb32_sdio_cyc), .i_wb_stb(wb32_sdio_stb), .i_wb_we(wb32_sdio_we),
			.i_wb_addr(wb32_sdio_addr[4-1:0]),
		...
		.o_cfg_phy_trim(o_sdio_cfg_phy_trim),
...
`endif
		...
		.i_wb_cyc(wb32_emmc_cyc), .i_wb_stb(wb32_emmc_stb), .i_wb_we(wb32_emmc_we),
			.i_wb_addr(wb32_emmc_addr[4-1:0]),
		...
		.o_cfg_phy_trim(o_emmc_cfg_phy_trim),
