...
// Deplist for @$(PREFIX)=cpunetscope
`ifdef	ETH_ROUTER
`define	CPUNETSCOPE_SCOPC
`endif	// ETH_ROUTER
...
// }}}
	...
	wire	cpunetscope_int;	// cpunetscope.INT.CPUNETSCOPE.WIRE
	// }}}
	////////////////////////////////////////////////////////////////////////
	//
...
// }}}
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component cpunetscope
	// Verilator lint_off UNUSED
	wire		wb32_cpunetscope_cyc, wb32_cpunetscope_stb, wb32_cpunetscope_we;
	wire	[8:0]	wb32_cpunetscope_addr;
	wire	[31:0]	wb32_cpunetscope_data;
	wire	[3:0]	wb32_cpunetscope_sel;
	wire		wb32_cpunetscope_stall, wb32_cpunetscope_ack, wb32_cpunetscope_err;
	wire	[31:0]	wb32_cpunetscope_idata;
	// Verilator lint_on UNUSED
	...
	assign	wb32_cpunetscope_err= 1'b0;
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 9'h050 }, //      i2cdma: 0x140
			{ 9'h040 }, //         i2c: 0x100
			{ 9'h030 }, //   sdioscope: 0x0c0
			{ 9'h020 }, //  routescope: 0x080
			{ 9'h010 }, //    i2cscope: 0x040
			{ 9'h000 }  // cpunetscope: 0x000
		}),
		.SLAVE_MASK({
			// Address width    = 9
			// Address LSBs     = 2
...
`ifdef	SDIOSCOPE_SCOPC
	...
	wbscopc #(
		...
		// {{{
		i_clk, 1'b1, sdio_debug[31], sdio_debug[30:0],
		i_clk,
...
`ifdef	CPUNETSCOPE_SCOPC
	// {{{
	wbscopc #(
		// {{{
		.LGMEM(10),
		.SYNCHRONOUS(1),
		.DEFAULT_HOLDOFF(1020)
		// }}}
	) cpunetscopei(
		// {{{
		i_clk, 1'b1, cpunet_debug[31], cpunet_debug[30:0],
		i_clk,
		wb32_cpunetscope_cyc, wb32_cpunetscope_stb, wb32_cpunetscope_we,
			wb32_cpunetscope_addr[1-1:0],
			wb32_cpunetscope_data, // 32 bits wide
			wb32_cpunetscope_sel,  // 32/8 bits wide
		wb32_cpunetscope_stall, wb32_cpunetscope_ack, wb32_cpunetscope_idata,
		cpunetscope_int
		// }}}
	);
	// }}}
`else	// CPUNETSCOPE_SCOPC
	// {{{
	// Null bus slave
	// {{{

	//
	// In the case that there is no wb32_cpunetscope peripheral
	// responding on the wb32 bus
	assign	wb32_cpunetscope_ack   = 1'b0;
	assign	wb32_cpunetscope_err   = (wb32_cpunetscope_stb);
	assign	wb32_cpunetscope_stall = 0;
	assign	wb32_cpunetscope_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	cpunetscope_int = 1'b0;	// cpunetscope.INT.CPUNETSCOPE.WIRE
	// }}}
	// }}}
`endif	// CPUNETSCOPE_SCOPC
