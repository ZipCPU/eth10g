...
//
// CmdLine:	autofpga -I .: -d -o . allclocks.txt siclk.txt sirefclk.txt global.txt wbdown.txt icape.txt version.txt pwrcount.txt rtccount.txt gpio.txt spio.txt wbuconsole.txt zipmaster.txt bkram.txt ddr3.txt flash.txt sdio.txt emmc.txt sata.txt netrouter.txt cpunet.txt netstats.txt hdmi.txt cec.txt edid.txt routescope.txt i2cscope.txt gatescope.txt netscope.txt satascope.txt sdioscope.txt emmcscope.txt flashscope.txt mem_bkram_only.txt mem_full.txt mem_flash_bkram.txt i2ccpu.txt fan.txt sirefclkcounter.txt netclk.txt
//
