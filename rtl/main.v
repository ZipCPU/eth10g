...
// }}}
	...
	wire	[6:0]	wb32_sirefclkcounter_addr;
	...
	assign	wb32_buildtime_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h0);  // 0x00
	...
	assign	wb32_gpio_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h1);  // 0x04
	...
	assign	wb32_netdbg_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h2);  // 0x08
	...
	assign	wb32_netlock_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h3);  // 0x0c
	...
	assign	wb32_siclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h4);  // 0x10
	...
	assign	wb32_sirefclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h5);  // 0x14
	...
	assign	wb32_sirefclkcounter_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h6);  // 0x18
	...
	assign	wb32_spio_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h7);  // 0x1c
	...
	assign	wb32_version_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h8);  // 0x20
	...
	assign	wb32_i2cdma_stb = wb32_dio_stb && ((wb32_dio_addr[ 4: 2] &  3'h7) ==  3'h1);  // 0x10 - 0x1f
	...
	assign	wb32_netclk_stb = wb32_dio_stb && ((wb32_dio_addr[ 4: 2] &  3'h6) ==  3'h2);  // 0x20 - 0x33
	...
	assign	wb32_sio_stb = wb32_dio_stb && ((wb32_dio_addr[ 4: 2] &  3'h4) ==  3'h4);  // 0x40 - 0x7f
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 7'h10 }, //    cpunet: 0x040
			{ 7'h0c }, //      uart: 0x030
			{ 7'h08 }, //  netscope: 0x020
			{ 7'h04 }, //  i2cscope: 0x010
			{ 7'h00 }  // emmcscope: 0x000
		}),
		.SLAVE_MASK({
			// Address width    = 7
			// Address LSBs     = 2
