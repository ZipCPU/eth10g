...
// }}}
	...
	wire	[7:0]	wb32_cpunetscope_addr;
	...
	assign	wb32_netreset_stb = wb32_sio_stb && (wb32_sio_addr[ 2: 0] ==  3'h2);  // 0x08
	...
	assign	wb32_siclk_stb = wb32_sio_stb && (wb32_sio_addr[ 2: 0] ==  3'h3);  // 0x0c
	...
	assign	wb32_sirefclk_stb = wb32_sio_stb && (wb32_sio_addr[ 2: 0] ==  3'h4);  // 0x10
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 8'h40 }, //         cfg: 0x100
			{ 8'h30 }, //        gnet: 0x0c0
			{ 8'h28 }, //    wb32_sio: 0x0a0
			{ 8'h20 }, //         fan: 0x080
			{ 8'h18 }, //        uart: 0x060
			{ 8'h10 }, //      i2cdma: 0x040
			{ 8'h08 }, //         i2c: 0x020
			{ 8'h00 }  // cpunetscope: 0x000
		}),
		.SLAVE_MASK({
			// Address width    = 8
			// Address LSBs     = 2
