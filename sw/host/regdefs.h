...
#define	R_I2CCPU         	0x02000020	// 02000020, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW     	0x02000024	// 02000020, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR    	0x02000028	// 02000020, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT 	0x0200002c	// 02000020, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA         	0x02000040	// 02000040, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR    	0x02000044	// 02000040, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE    	0x02000048	// 02000040, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN     	0x0200004c	// 02000040, wbregs names: I2CDMALEN
// CONSOLE registers
#define	R_CONSOLE_FIFO   	0x02000064	// 02000060, wbregs names: UFIFO
#define	R_CONSOLE_UARTRX 	0x02000068	// 02000060, wbregs names: RX
#define	R_CONSOLE_UARTTX 	0x0200006c	// 02000060, wbregs names: TX
#define	R_FAN_FPGAPWM    	0x02000080	// 02000080, wbregs names: FAN_FPGAPWM
#define	R_FAN_SYSPWM     	0x02000084	// 02000080, wbregs names: FAN_SYSPWM
#define	R_FAN_TACH       	0x02000088	// 02000080, wbregs names: FAN_TACH
#define	R_FAN_TEMP       	0x0200008c	// 02000080, wbregs names: FAN_TEMP
#define	R_FAN            	0x02000090	// 02000080, wbregs names: FAN_CTRL
#define	R_FAN_OVW        	0x02000094	// 02000080, wbregs names: FAN_OVW, FAN_OVERRIDE
#define	R_FAN_ADDR       	0x02000098	// 02000080, wbregs names: FAN_ADDR, FAN_ADDRESS
#define	R_FAN_CKCOUNT    	0x0200009c	// 02000080, wbregs names: FANCLK, FAN_CKCOUNT
#define	R_BUILDTIME      	0x020000a0	// 020000a0, wbregs names: BUILDTIME
#define	R_GPIO           	0x020000a4	// 020000a4, wbregs names: GPIO, GPI, GPO
#define	R_NETRESET       	0x020000a8	// 020000a8, wbregs names: NETRESET
#define	R_SICLKFREQ      	0x020000ac	// 020000ac, wbregs names: SICLKFREQ
#define	R_SIREFCLK       	0x020000b0	// 020000b0, wbregs names: SIREFCLK
#define	R_SPIO           	0x020000b4	// 020000b4, wbregs names: SPIO
#define	R_VERSION        	0x020000b8	// 020000b8, wbregs names: VERSION
...
#define	R_CPUNET         	0x02000180	// 02000180, wbregs names: CPUNET
#define	R_CPUNETMAC1     	0x02000184	// 02000180, wbregs names: CPUMAC1
#define	R_CPUNETMAC2     	0x02000188	// 02000180, wbregs names: CPUMAC2
#define	R_CPUNETIPV4     	0x0200018c	// 02000180, wbregs names: CPUIPV4
#define	R_CPUNETIPV6P1   	0x02000190	// 02000180, wbregs names: CPUIP6P1
#define	R_CPUNETIPV6P2   	0x02000194	// 02000180, wbregs names: CPUIP6P2
#define	R_CPUNETIPV6P3   	0x02000198	// 02000180, wbregs names: CPUIP6P3
#define	R_CPUNETIPV6P4   	0x0200019c	// 02000180, wbregs names: CPUIP6P4
#define	R_CPUNETRXDROPS  	0x020001a0	// 02000180, wbregs names: RXDROPS
#define	R_CPUNETRXPKTS   	0x020001a4	// 02000180, wbregs names: RXPKTS
#define	R_CPUNETTXPKTS   	0x020001a8	// 02000180, wbregs names: TXPKTS
#define	R_CPUNETTX_BASE  	0x020001c0	// 02000180, wbregs names: CNTXBASE, CPUNETTXBASE
#define	R_CPUNETTX_LEN   	0x020001c4	// 02000180, wbregs names: CNTXLEN, CPUNETTXLEN
#define	R_CPUNETTX_RPTR  	0x020001c8	// 02000180, wbregs names: CNTXRPTR, CPUNETTXRPTR
#define	R_CPUNETTX_WPTR  	0x020001cc	// 02000180, wbregs names: CNTXWPTR, CPUNETTXWPTR
#define	R_CPUNETRX_BASE  	0x020001d0	// 02000180, wbregs names: CNRXBASE, CPUNETRXBASE
#define	R_CPUNETRX_LEN   	0x020001d4	// 02000180, wbregs names: CNRXLEN, CPUNETRXLEN
#define	R_CPUNETRX_RPTR  	0x020001d8	// 02000180, wbregs names: CNRXRPTR, CPUNETRXRPTR
#define	R_CPUNETRX_WPTR  	0x020001dc	// 02000180, wbregs names: CNRXWPTR, CPUNETRXWPTR
#define	R_CPUNETRX_DBG   	0x020001e0	// 02000180, wbregs names: CNRXDBG, CPUNETRXDBG
#define	R_CPUNETTX_DBG   	0x020001e4	// 02000180, wbregs names: CNTXDBG, CPUNETTXDBG
