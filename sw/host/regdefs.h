...
#define	R_I2CCPU        	0x008000a0	// 008000a0, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW    	0x008000a4	// 008000a0, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR   	0x008000a8	// 008000a0, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT	0x008000ac	// 008000a0, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
// SD-SPI addresses
#define	R_SDSPI_CTRL    	0x008000c0	// 008000c0, wbregs names: SDCARD
#define	R_SDSPI_DATA    	0x008000c4	// 008000c0, wbregs names: SDDATA
#define	R_SDSPI_FIFOA   	0x008000c8	// 008000c0, wbregs names: SDFIFOA, SDFIF0, SDFIFA
#define	R_SDSPI_FIFOB   	0x008000cc	// 008000c0, wbregs names: SDFIFOB, SDFIF1, SDFIFB
// CONSOLE registers
#define	R_CONSOLE_FIFO  	0x008000e4	// 008000e0, wbregs names: UFIFO
#define	R_CONSOLE_UARTRX	0x008000e8	// 008000e0, wbregs names: RX
#define	R_CONSOLE_UARTTX	0x008000ec	// 008000e0, wbregs names: TX
#define	R_FAN_FPGAPWM   	0x00800100	// 00800100, wbregs names: FAN_FPGAPWM
#define	R_FAN_SYSPWM    	0x00800104	// 00800100, wbregs names: FAN_SYSPWM
#define	R_FAN_TACH      	0x00800108	// 00800100, wbregs names: FAN_TACH
#define	R_FAN_TEMP      	0x0080010c	// 00800100, wbregs names: FAN_TEMP
#define	R_FAN           	0x00800110	// 00800100, wbregs names: FAN_CTRL
#define	R_FAN_OVW       	0x00800114	// 00800100, wbregs names: FAN_OVW, FAN_OVERRIDE
#define	R_FAN_ADDR      	0x00800118	// 00800100, wbregs names: FAN_ADDR, FAN_ADDRESS
#define	R_FAN_CKCOUNT   	0x0080011c	// 00800100, wbregs names: FANCLK, FAN_CKCOUNT
#define	R_BUILDTIME     	0x00800120	// 00800120, wbregs names: BUILDTIME
#define	R_GPIO          	0x00800124	// 00800124, wbregs names: GPIO, GPI, GPO
#define	R_SIREFCLK      	0x00800128	// 00800128, wbregs names: SIREFCLK
#define	R_SPIO          	0x0080012c	// 0080012c, wbregs names: SPIO
#define	R_VERSION       	0x00800130	// 00800130, wbregs names: VERSION
