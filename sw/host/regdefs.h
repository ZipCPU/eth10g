...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	autofpga -I .: -d -o . allclocks.txt global.txt wbdown.txt version.txt gpio.txt spio.txt wbuconsole.txt zipmaster.txt bkram.txt flash.txt sdspi.txt mem_bkram_only.txt mem_flash_bkram.txt mem_bootrom_bkram.txt mem_sdram_only.txt i2ccpu.txt fan.txt sirefclk.txt
//
...
#define	R_I2CCPU        	0x00800010	// 00800010, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW    	0x00800014	// 00800010, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR   	0x00800018	// 00800010, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT	0x0080001c	// 00800010, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
// SD-SPI addresses
#define	R_SDSPI_CTRL    	0x00800020	// 00800020, wbregs names: SDCARD
#define	R_SDSPI_DATA    	0x00800024	// 00800020, wbregs names: SDDATA
#define	R_SDSPI_FIFOA   	0x00800028	// 00800020, wbregs names: SDFIFOA, SDFIF0, SDFIFA
#define	R_SDSPI_FIFOB   	0x0080002c	// 00800020, wbregs names: SDFIFOB, SDFIF1, SDFIFB
// CONSOLE registers
#define	R_CONSOLE_FIFO  	0x00800034	// 00800030, wbregs names: UFIFO
#define	R_CONSOLE_UARTRX	0x00800038	// 00800030, wbregs names: RX
#define	R_CONSOLE_UARTTX	0x0080003c	// 00800030, wbregs names: TX
#define	R_FAN_FPGAPWM   	0x00800040	// 00800040, wbregs names: FAN_FPGAPWM
#define	R_FAN_SYSPWM    	0x00800044	// 00800040, wbregs names: FAN_SYSPWM
#define	R_FAN_TACH      	0x00800048	// 00800040, wbregs names: FAN_TACH
#define	R_FAN_TEMP      	0x0080004c	// 00800040, wbregs names: FAN_TEMP
#define	R_FAN           	0x00800050	// 00800040, wbregs names: FAN_CTRL
#define	R_FAN_OVW       	0x00800054	// 00800040, wbregs names: FAN_OVW, FAN_OVERRIDE
#define	R_FAN_ADDR      	0x00800058	// 00800040, wbregs names: FAN_ADDR, FAN_ADDRESS
#define	R_FAN_CKCOUNT   	0x0080005c	// 00800040, wbregs names: FANCLK, FAN_CKCOUNT
#define	R_BUILDTIME     	0x00800060	// 00800060, wbregs names: BUILDTIME
#define	R_GPIO          	0x00800064	// 00800064, wbregs names: GPIO, GPI, GPO
#define	R_SIREFCLK      	0x00800068	// 00800068, wbregs names: SIREFCLK
#define	R_SPIO          	0x0080006c	// 0080006c, wbregs names: SPIO
#define	R_VERSION       	0x00800070	// 00800070, wbregs names: VERSION
