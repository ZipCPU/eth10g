...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	autofpga -I .: -d -o . allclocks.txt global.txt wbdown.txt icape.txt version.txt gpio.txt spio.txt wbuconsole.txt zipmaster.txt smiconsole.txt bkram.txt flash.txt sdio.txt hdmi.txt cec.txt edid.txt smiscope.txt flashscope.txt fanscope.txt cfgscope.txt sdioscope.txt mem_bkram_only.txt mem_flash_bkram.txt i2ccpu.txt fan.txt sirefclk.txt i2cscope.txt netled.txt
//
...
#define	R_SDIOSCOPE     	0x00800300	// 00800300, wbregs names: SDIOSCOPE
#define	R_SDIOSCOPED    	0x00800304	// 00800300, wbregs names: SDIOSCOPED
// CONSOLE registers
#define	R_CONSOLE_FIFO  	0x00800384	// 00800380, wbregs names: UFIFO
#define	R_CONSOLE_UARTRX	0x00800388	// 00800380, wbregs names: RX
#define	R_CONSOLE_UARTTX	0x0080038c	// 00800380, wbregs names: TX
#define	R_FAN_FPGAPWM   	0x00800400	// 00800400, wbregs names: FAN_FPGAPWM
#define	R_FAN_SYSPWM    	0x00800404	// 00800400, wbregs names: FAN_SYSPWM
#define	R_FAN_TACH      	0x00800408	// 00800400, wbregs names: FAN_TACH
#define	R_FAN_TEMP      	0x0080040c	// 00800400, wbregs names: FAN_TEMP
#define	R_FAN           	0x00800410	// 00800400, wbregs names: FAN_CTRL
#define	R_FAN_OVW       	0x00800414	// 00800400, wbregs names: FAN_OVW, FAN_OVERRIDE
#define	R_FAN_ADDR      	0x00800418	// 00800400, wbregs names: FAN_ADDR, FAN_ADDRESS
#define	R_FAN_CKCOUNT   	0x0080041c	// 00800400, wbregs names: FANCLK, FAN_CKCOUNT
// SDIO SD Card addresses
#define	R_SDIO_CTRL     	0x00800480	// 00800480, wbregs names: SDCARD
#define	R_SDIO_DATA     	0x00800484	// 00800480, wbregs names: SDDATA
#define	R_SDIO_FIFOA    	0x00800488	// 00800480, wbregs names: SDFIFOA, SDFIF0, SDFIFA
#define	R_SDIO_FIFOB    	0x0080048c	// 00800480, wbregs names: SDFIFOB, SDFIF1, SDFIFB
#define	R_SDIO_PHY      	0x00800490	// 00800480, wbregs names: SDPHY
// FPGA CONFIG REGISTERS: 0x4e0-0x4ff
#define	R_CFG_CRC       	0x00800500	// 00800500, wbregs names: FPGACRC
#define	R_CFG_FAR       	0x00800504	// 00800500, wbregs names: FPGAFAR
#define	R_CFG_FDRI      	0x00800508	// 00800500, wbregs names: FPGAFDRI
#define	R_CFG_FDRO      	0x0080050c	// 00800500, wbregs names: FPGAFDRO
#define	R_CFG_CMD       	0x00800510	// 00800500, wbregs names: FPGACMD
#define	R_CFG_CTL0      	0x00800514	// 00800500, wbregs names: FPGACTL0
#define	R_CFG_MASK      	0x00800518	// 00800500, wbregs names: FPGAMASK
#define	R_CFG_STAT      	0x0080051c	// 00800500, wbregs names: FPGASTAT
#define	R_CFG_LOUT      	0x00800520	// 00800500, wbregs names: FPGALOUT
#define	R_CFG_COR0      	0x00800524	// 00800500, wbregs names: FPGACOR0
#define	R_CFG_MFWR      	0x00800528	// 00800500, wbregs names: FPGAMFWR
#define	R_CFG_CBC       	0x0080052c	// 00800500, wbregs names: FPGACBC
#define	R_CFG_IDCODE    	0x00800530	// 00800500, wbregs names: FPGAIDCODE
#define	R_CFG_AXSS      	0x00800534	// 00800500, wbregs names: FPGAAXSS
#define	R_CFG_COR1      	0x00800538	// 00800500, wbregs names: FPGACOR1
#define	R_CFG_WBSTAR    	0x00800540	// 00800500, wbregs names: WBSTAR
#define	R_CFG_TIMER     	0x00800544	// 00800500, wbregs names: CFGTIMER
...
#define	R_I2CCPU        	0x00800600	// 00800600, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW    	0x00800604	// 00800600, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR   	0x00800608	// 00800600, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT	0x0080060c	// 00800600, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA        	0x00800640	// 00800640, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR   	0x00800644	// 00800640, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE   	0x00800648	// 00800640, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN    	0x0080064c	// 00800640, wbregs names: I2CDMALEN
#define	R_BUILDTIME     	0x00800680	// 00800680, wbregs names: BUILDTIME
#define	R_GPIO          	0x00800684	// 00800684, wbregs names: GPIO, GPI, GPO
#define	R_SIREFCLK      	0x00800688	// 00800688, wbregs names: SIREFCLK
#define	R_SPIO          	0x0080068c	// 0080068c, wbregs names: SPIO
#define	R_VERSION       	0x00800690	// 00800690, wbregs names: VERSION
