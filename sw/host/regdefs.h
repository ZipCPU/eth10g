...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	autofpga -I .: -d -o . allclocks.txt siclk.txt sirefclk.txt global.txt wbdown.txt icape.txt version.txt gpio.txt spio.txt wbuconsole.txt zipmaster.txt bkram.txt ddr3.txt netrouter.txt cpunet.txt routescope.txt i2cscope.txt sdioscope.txt mem_bkram_only.txt mem_full.txt i2ccpu.txt fan.txt sirefclkcounter.txt
//
...
#define	R_I2CCPU         	0x02000180	// 02000180, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW     	0x02000184	// 02000180, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR    	0x02000188	// 02000180, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT 	0x0200018c	// 02000180, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA         	0x02000200	// 02000200, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR    	0x02000204	// 02000200, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE    	0x02000208	// 02000200, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN     	0x0200020c	// 02000200, wbregs names: I2CDMALEN
// CONSOLE registers
...
// Fan registers
#define	R_FAN_FPGAPWM    	0x02000300	// 02000300, wbregs names: FAN_FPGAPWM
#define	R_FAN_SYSPWM     	0x02000304	// 02000300, wbregs names: FAN_SYSPWM
#define	R_FAN_TACH       	0x02000308	// 02000300, wbregs names: FAN_TACH
#define	R_FAN_TEMP       	0x0200030c	// 02000300, wbregs names: FAN_TEMP
#define	R_FAN            	0x02000310	// 02000300, wbregs names: FAN_CTRL
#define	R_FAN_OVW        	0x02000314	// 02000300, wbregs names: FAN_OVW, FAN_OVERRIDE
#define	R_FAN_ADDR       	0x02000318	// 02000300, wbregs names: FAN_ADDR, FAN_ADDRESS
#define	R_FAN_CKCOUNT    	0x0200031c	// 02000300, wbregs names: FANCLK, FAN_CKCOUNT
#define	R_BUILDTIME      	0x02000380	// 02000380, wbregs names: BUILDTIME
#define	R_GPIO           	0x02000384	// 02000384, wbregs names: GPIO, GPI, GPO
#define	R_NETRESET       	0x02000388	// 02000388, wbregs names: NETRESET
#define	R_SICLKFREQ      	0x0200038c	// 0200038c, wbregs names: SICLKFREQ
#define	R_SIREFCLK       	0x02000390	// 02000390, wbregs names: SIREFCLK
#define	R_SIREFFREQ      	0x02000394	// 02000394, wbregs names: SIREFFREQ
#define	R_SPIO           	0x02000398	// 02000398, wbregs names: SPIO
#define	R_VERSION        	0x0200039c	// 0200039c, wbregs names: VERSION
// FPGA CONFIG REGISTERS: 0x4e0-0x4ff
#define	R_CFG_CRC        	0x02000400	// 02000400, wbregs names: FPGACRC
#define	R_CFG_FAR        	0x02000404	// 02000400, wbregs names: FPGAFAR
#define	R_CFG_FDRI       	0x02000408	// 02000400, wbregs names: FPGAFDRI
#define	R_CFG_FDRO       	0x0200040c	// 02000400, wbregs names: FPGAFDRO
#define	R_CFG_CMD        	0x02000410	// 02000400, wbregs names: FPGACMD
#define	R_CFG_CTL0       	0x02000414	// 02000400, wbregs names: FPGACTL0
#define	R_CFG_MASK       	0x02000418	// 02000400, wbregs names: FPGAMASK
#define	R_CFG_STAT       	0x0200041c	// 02000400, wbregs names: FPGASTAT
#define	R_CFG_LOUT       	0x02000420	// 02000400, wbregs names: FPGALOUT
#define	R_CFG_COR0       	0x02000424	// 02000400, wbregs names: FPGACOR0
#define	R_CFG_MFWR       	0x02000428	// 02000400, wbregs names: FPGAMFWR
#define	R_CFG_CBC        	0x0200042c	// 02000400, wbregs names: FPGACBC
#define	R_CFG_IDCODE     	0x02000430	// 02000400, wbregs names: FPGAIDCODE
#define	R_CFG_AXSS       	0x02000434	// 02000400, wbregs names: FPGAAXSS
#define	R_CFG_COR1       	0x02000438	// 02000400, wbregs names: FPGACOR1
#define	R_CFG_WBSTAR     	0x02000440	// 02000400, wbregs names: WBSTAR
#define	R_CFG_TIMER      	0x02000444	// 02000400, wbregs names: CFGTIMER
#define	R_CFG_BOOTSTS    	0x02000458	// 02000400, wbregs names: BOOTSTS
#define	R_CFG_CTL1       	0x02000460	// 02000400, wbregs names: FPGACTL1
#define	R_CFG_BSPI       	0x0200047c	// 02000400, wbregs names: FPGABSPI
// CPU Net Controller registers
#define	R_CPUNET         	0x02000480	// 02000480, wbregs names: CPUNET
#define	R_CPUNETMAC1     	0x02000484	// 02000480, wbregs names: CPUMAC1
#define	R_CPUNETMAC2     	0x02000488	// 02000480, wbregs names: CPUMAC2
#define	R_CPUNETIPV4     	0x0200048c	// 02000480, wbregs names: CPUIPV4
#define	R_CPUNETIPV6P1   	0x02000490	// 02000480, wbregs names: CPUIP6P1
#define	R_CPUNETIPV6P2   	0x02000494	// 02000480, wbregs names: CPUIP6P2
#define	R_CPUNETIPV6P3   	0x02000498	// 02000480, wbregs names: CPUIP6P3
#define	R_CPUNETIPV6P4   	0x0200049c	// 02000480, wbregs names: CPUIP6P4
#define	R_CPUNETRXDROPS  	0x020004a0	// 02000480, wbregs names: RXDROPS
#define	R_CPUNETRXPKTS   	0x020004a4	// 02000480, wbregs names: RXPKTS
#define	R_CPUNETTXPKTS   	0x020004a8	// 02000480, wbregs names: TXPKTS
#define	R_CPUNETTX_BASE  	0x020004c0	// 02000480, wbregs names: CNTXBASE, CPUNETTXBASE
#define	R_CPUNETTX_LEN   	0x020004c4	// 02000480, wbregs names: CNTXLEN, CPUNETTXLEN
#define	R_CPUNETTX_RPTR  	0x020004c8	// 02000480, wbregs names: CNTXRPTR, CPUNETTXRPTR
#define	R_CPUNETTX_WPTR  	0x020004cc	// 02000480, wbregs names: CNTXWPTR, CPUNETTXWPTR
#define	R_CPUNETRX_BASE  	0x020004d0	// 02000480, wbregs names: CNRXBASE, CPUNETRXBASE
#define	R_CPUNETRX_LEN   	0x020004d4	// 02000480, wbregs names: CNRXLEN, CPUNETRXLEN
#define	R_CPUNETRX_RPTR  	0x020004d8	// 02000480, wbregs names: CNRXRPTR, CPUNETRXRPTR
#define	R_CPUNETRX_WPTR  	0x020004dc	// 02000480, wbregs names: CNRXWPTR, CPUNETRXWPTR
#define	R_CPUNETRX_DBG   	0x020004e0	// 02000480, wbregs names: CNRXDBG, CPUNETRXDBG
#define	R_CPUNETTX_DBG   	0x020004e4	// 02000480, wbregs names: CNTXDBG, CPUNETTXDBG
