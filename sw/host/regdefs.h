...
#define	R_SATADRPSCOPE    	0x02000280	// 02000280, wbregs names: SATADRPSCOPE
#define	R_SATADRPSCOPED   	0x02000284	// 02000280, wbregs names: SATADRPSCOPED
// satalscope compressed scope
#define	R_SATALSCOPE      	0x02000300	// 02000300, wbregs names: SATALSCOPE
#define	R_SATALSCOPED     	0x02000304	// 02000300, wbregs names: SATALSCOPED
// satapscope compressed scope
#define	R_SATAPSCOPE      	0x02000380	// 02000380, wbregs names: SATAPSCOPE
#define	R_SATAPSCOPED     	0x02000384	// 02000380, wbregs names: SATAPSCOPED
// satarscope compressed scope
#define	R_SATARSCOPE      	0x02000400	// 02000400, wbregs names: SATARSCOPE
#define	R_SATARSCOPED     	0x02000404	// 02000400, wbregs names: SATARSCOPED
// satatscope compressed scope
#define	R_SATATSCOPE      	0x02000480	// 02000480, wbregs names: SATATSCOPE
#define	R_SATATSCOPED     	0x02000484	// 02000480, wbregs names: SATATSCOPED
// zipscope scope
#define	R_ZIPSCOPE        	0x02000500	// 02000500, wbregs names: ZIPSCOPE
#define	R_ZIPSCOPED       	0x02000504	// 02000500, wbregs names: ZIPSCOPED
// CONSOLE registers
...
#define	R_SDIO_FIFOA      	0x02000788	// 02000780, wbregs names: SDFIFOA, SDFIF0, SDFIFA
#define	R_SDIO_FIFOB      	0x0200078c	// 02000780, wbregs names: SDFIFOB, SDFIF1, SDFIFB
...
#define	R_CFG_FDRI        	0x02000808	// 02000800, wbregs names: FPGAFDRI
#define	R_CFG_FDRO        	0x0200080c	// 02000800, wbregs names: FPGAFDRO
#define	R_CFG_CMD         	0x02000810	// 02000800, wbregs names: FPGACMD
#define	R_CFG_CTL0        	0x02000814	// 02000800, wbregs names: FPGACTL0
#define	R_CFG_MASK        	0x02000818	// 02000800, wbregs names: FPGAMASK
#define	R_CFG_STAT        	0x0200081c	// 02000800, wbregs names: FPGASTAT
#define	R_CFG_LOUT        	0x02000820	// 02000800, wbregs names: FPGALOUT
#define	R_CFG_COR0        	0x02000824	// 02000800, wbregs names: FPGACOR0
#define	R_CFG_MFWR        	0x02000828	// 02000800, wbregs names: FPGAMFWR
#define	R_CFG_CBC         	0x0200082c	// 02000800, wbregs names: FPGACBC
#define	R_CFG_IDCODE      	0x02000830	// 02000800, wbregs names: FPGAIDCODE
#define	R_CFG_AXSS        	0x02000834	// 02000800, wbregs names: FPGAAXSS
#define	R_CFG_COR1        	0x02000838	// 02000800, wbregs names: FPGACOR1
#define	R_CFG_WBSTAR      	0x02000840	// 02000800, wbregs names: WBSTAR
#define	R_CFG_TIMER       	0x02000844	// 02000800, wbregs names: CFGTIMER
#define	R_CFG_BOOTSTS     	0x02000858	// 02000800, wbregs names: BOOTSTS
#define	R_CFG_CTL1        	0x02000860	// 02000800, wbregs names: FPGACTL1
#define	R_CFG_BSPI        	0x0200087c	// 02000800, wbregs names: FPGABSPI
// CPU Net Controller registers
#define	R_CPUNET          	0x02000880	// 02000880, wbregs names: CPUNET
#define	R_CPUNETMAC1      	0x02000884	// 02000880, wbregs names: CPUMAC1
#define	R_CPUNETMAC2      	0x02000888	// 02000880, wbregs names: CPUMAC2
#define	R_CPUNETIPV4      	0x0200088c	// 02000880, wbregs names: CPUIPV4
#define	R_CPUNETIPV6P1    	0x02000890	// 02000880, wbregs names: CPUIP6P1
#define	R_CPUNETIPV6P2    	0x02000894	// 02000880, wbregs names: CPUIP6P2
#define	R_CPUNETIPV6P3    	0x02000898	// 02000880, wbregs names: CPUIP6P3
#define	R_CPUNETIPV6P4    	0x0200089c	// 02000880, wbregs names: CPUIP6P4
#define	R_CPUNETRXDROPS   	0x020008a0	// 02000880, wbregs names: RXDROPS
#define	R_CPUNETRXPKTS    	0x020008a4	// 02000880, wbregs names: RXPKTS
#define	R_CPUNETTXPKTS    	0x020008a8	// 02000880, wbregs names: TXPKTS
#define	R_CPUNETTX_BASE   	0x020008c0	// 02000880, wbregs names: CNTXBASE, CPUNETTXBASE
#define	R_CPUNETTX_LEN    	0x020008c4	// 02000880, wbregs names: CNTXLEN, CPUNETTXLEN
#define	R_CPUNETTX_RPTR   	0x020008c8	// 02000880, wbregs names: CNTXRPTR, CPUNETTXRPTR
#define	R_CPUNETTX_WPTR   	0x020008cc	// 02000880, wbregs names: CNTXWPTR, CPUNETTXWPTR
#define	R_CPUNETRX_BASE   	0x020008d0	// 02000880, wbregs names: CNRXBASE, CPUNETRXBASE
#define	R_CPUNETRX_LEN    	0x020008d4	// 02000880, wbregs names: CNRXLEN, CPUNETRXLEN
#define	R_CPUNETRX_RPTR   	0x020008d8	// 02000880, wbregs names: CNRXRPTR, CPUNETRXRPTR
#define	R_CPUNETRX_WPTR   	0x020008dc	// 02000880, wbregs names: CNRXWPTR, CPUNETRXWPTR
#define	R_CPUNETRX_DBG    	0x020008e0	// 02000880, wbregs names: CNRXDBG, CPUNETRXDBG
#define	R_CPUNETTX_DBG    	0x020008e4	// 02000880, wbregs names: CNTXDBG, CPUNETTXDBG
// I2C Controller registers
#define	R_I2CCPU          	0x02000900	// 02000900, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW      	0x02000904	// 02000900, wbregs names: I2COVW, I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR     	0x02000908	// 02000900, wbregs names: I2CADDR, I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT  	0x0200090c	// 02000900, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA          	0x02000910	// 02000910, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR     	0x02000914	// 02000910, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE     	0x02000918	// 02000910, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN      	0x0200091c	// 02000910, wbregs names: I2CDMALEN
#define	R_RXNETCK0        	0x02000920	// 02000920, wbregs names: RXNETCLK0, RXNETCK0
#define	R_RXNETCK1        	0x02000924	// 02000920, wbregs names: RXNETCLK1, RXNETCK1
#define	R_RXNETCK2        	0x02000928	// 02000920, wbregs names: RXNETCLK2, RXNETCK2
#define	R_RXNETCK3        	0x0200092c	// 02000920, wbregs names: RXNETCLK3, RXNETCK3
#define	R_TXNETCLK        	0x02000930	// 02000920, wbregs names: TXNETCLK
#define	R_REFNETCLK       	0x02000934	// 02000920, wbregs names: REFNETCLK
#define	R_BUILDTIME       	0x02000940	// 02000940, wbregs names: BLDTIME, BUILDTIME
#define	R_GPIO            	0x02000944	// 02000944, wbregs names: GPIO, GPI, GPO
#define	R_NETDBG          	0x02000948	// 02000948, wbregs names: NETDBG
#define	R_NETLOCK         	0x0200094c	// 0200094c, wbregs names: NETLOCK
#define	R_NETRESET        	0x02000950	// 02000950, wbregs names: NETRESET
#define	R_PWRCOUNT        	0x02000954	// 02000954, wbregs names: PWRCOUNT
#define	R_RTCCOUNT        	0x02000958	// 02000958, wbregs names: RTCCOUNT
#define	R_SATAREF         	0x0200095c	// 0200095c, wbregs names: SATAREF
#define	R_SATARX          	0x02000960	// 02000960, wbregs names: SATARX, SATARXCLK, SATARXCK
#define	R_SATATX          	0x02000964	// 02000964, wbregs names: SATATX, SATATXCLK, SATATXCK
#define	R_SCOPEPIC        	0x02000968	// 02000968, wbregs names: SCOPEPIC
#define	R_SICLKFREQ       	0x0200096c	// 0200096c, wbregs names: SICLKFREQ
#define	R_SIREFCLK        	0x02000970	// 02000970, wbregs names: SIREFCLK
#define	R_SIREFFREQ       	0x02000974	// 02000974, wbregs names: SIREFFREQ
#define	R_SPIO            	0x02000978	// 02000978, wbregs names: SPIO
#define	R_VERSION         	0x0200097c	// 0200097c, wbregs names: VERSION
...
// SWLOAD constants (host)
// {{{
#define	SWLOAD_MAGIC		0x53574c44	// 'SWLD'
#define	SWLOAD_CMD_IDLE		0x00000000
#define	SWLOAD_CMD_GO		0x00000001
#define	SWLOAD_STAT_WAIT	0x57414954	// 'WAIT'
#define	SWLOAD_STAT_DONE	0x444f4e45	// 'DONE'
#define	SWLOAD_STAT_FAIL	0x4641494c	// 'FAIL'
