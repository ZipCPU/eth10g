...
#define	R_SDIOSCOPE     	0x00040030	// 00040030, wbregs names: SDIOSCOPE
#define	R_SDIOSCOPED    	0x00040034	// 00040030, wbregs names: SDIOSCOPED
// I2C Controller registers
#define	R_I2CCPU        	0x00040040	// 00040040, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW    	0x00040044	// 00040040, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR   	0x00040048	// 00040040, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT	0x0004004c	// 00040040, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA        	0x00040050	// 00040050, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR   	0x00040054	// 00040050, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE   	0x00040058	// 00040050, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN    	0x0004005c	// 00040050, wbregs names: I2CDMALEN
// CONSOLE registers
#define	R_CONSOLE_FIFO  	0x00040064	// 00040060, wbregs names: UFIFO
#define	R_CONSOLE_UARTRX	0x00040068	// 00040060, wbregs names: RX
#define	R_CONSOLE_UARTTX	0x0004006c	// 00040060, wbregs names: TX
// CPU Net Controller registers
#define	R_CPUNETRX_BASE 	0x00040080	// 00040080, wbregs names: CPUNETRXBASE
#define	R_CPUNETRX_LEN  	0x00040084	// 00040080, wbregs names: CPUNETRXLEN
#define	R_CPUNETRX_RPTR 	0x00040088	// 00040080, wbregs names: CPUNETRXRPTR
#define	R_CPUNETRX_WPTR 	0x0004008c	// 00040080, wbregs names: CPUNETRXWPTR
// eMMC Card addresses
#define	R_EMMC_CTRL     	0x000400a0	// 000400a0, wbregs names: EMMCCARD
#define	R_EMMC_DATA     	0x000400a4	// 000400a0, wbregs names: EMMCDATA
#define	R_EMMC_FIFOA    	0x000400a8	// 000400a0, wbregs names: EMMCFIFOA, EMMCFIF0, EMMCFIFA
#define	R_EMMC_FIFOB    	0x000400ac	// 000400a0, wbregs names: EMMCFIFOB, EMMCFIF1, EMMCFIFB
#define	R_EMMC_PHY      	0x000400b0	// 000400a0, wbregs names: EMMCPHY
#define	R_FAN_FPGAPWM   	0x000400c0	// 000400c0, wbregs names: FAN_FPGAPWM
#define	R_FAN_SYSPWM    	0x000400c4	// 000400c0, wbregs names: FAN_SYSPWM
#define	R_FAN_TACH      	0x000400c8	// 000400c0, wbregs names: FAN_TACH
#define	R_FAN_TEMP      	0x000400cc	// 000400c0, wbregs names: FAN_TEMP
#define	R_FAN           	0x000400d0	// 000400c0, wbregs names: FAN_CTRL
#define	R_FAN_OVW       	0x000400d4	// 000400c0, wbregs names: FAN_OVW, FAN_OVERRIDE
#define	R_FAN_ADDR      	0x000400d8	// 000400c0, wbregs names: FAN_ADDR, FAN_ADDRESS
#define	R_FAN_CKCOUNT   	0x000400dc	// 000400c0, wbregs names: FANCLK, FAN_CKCOUNT
// SDIO SD Card addresses
#define	R_SDIO_CTRL     	0x000400e0	// 000400e0, wbregs names: SDCARD
#define	R_SDIO_DATA     	0x000400e4	// 000400e0, wbregs names: SDDATA
#define	R_SDIO_FIFOA    	0x000400e8	// 000400e0, wbregs names: SDFIFOA, SDFIF0, SDFIFA
#define	R_SDIO_FIFOB    	0x000400ec	// 000400e0, wbregs names: SDFIFOB, SDFIF1, SDFIFB
#define	R_SDIO_PHY      	0x000400f0	// 000400e0, wbregs names: SDPHY
#define	R_BUILDTIME     	0x00040100	// 00040100, wbregs names: BUILDTIME
#define	R_GPIO          	0x00040104	// 00040104, wbregs names: GPIO, GPI, GPO
#define	R_NETDBG        	0x00040108	// 00040108, wbregs names: NETDBG
#define	R_NETLOCK       	0x0004010c	// 0004010c, wbregs names: NETLOCK
#define	R_SIREFCLK      	0x00040110	// 00040110, wbregs names: SIREFCLK
#define	R_SPIO          	0x00040114	// 00040114, wbregs names: SPIO
#define	R_VERSION       	0x00040118	// 00040118, wbregs names: VERSION
