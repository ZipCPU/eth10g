...
#define	R_I2CSCOPE      	0x00800080	// 00800080, wbregs names: I2CSCOPE
#define	R_I2CSCOPED     	0x00800084	// 00800080, wbregs names: I2CSCOPED
// scope_smi compressed scope
#define	R_SMISCOPE      	0x008000a0	// 008000a0, wbregs names: SMISCOPE
#define	R_SMISCOPED     	0x008000a4	// 008000a0, wbregs names: SMISCOPED
// sdioscope compressed scope
#define	R_SDIOSCOPE     	0x008000c0	// 008000c0, wbregs names: SDIOSCOPE
#define	R_SDIOSCOPED    	0x008000c4	// 008000c0, wbregs names: SDIOSCOPED
// I2C Controller registers
#define	R_I2CCPU        	0x008000e0	// 008000e0, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW    	0x008000e4	// 008000e0, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR   	0x008000e8	// 008000e0, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT	0x008000ec	// 008000e0, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA        	0x00800100	// 00800100, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR   	0x00800104	// 00800100, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE   	0x00800108	// 00800100, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN    	0x0080010c	// 00800100, wbregs names: I2CDMALEN
// CONSOLE registers
#define	R_CONSOLE_FIFO  	0x00800124	// 00800120, wbregs names: UFIFO
#define	R_CONSOLE_UARTRX	0x00800128	// 00800120, wbregs names: RX
#define	R_CONSOLE_UARTTX	0x0080012c	// 00800120, wbregs names: TX
#define	R_FAN_FPGAPWM   	0x00800140	// 00800140, wbregs names: FAN_FPGAPWM
#define	R_FAN_SYSPWM    	0x00800144	// 00800140, wbregs names: FAN_SYSPWM
#define	R_FAN_TACH      	0x00800148	// 00800140, wbregs names: FAN_TACH
#define	R_FAN_TEMP      	0x0080014c	// 00800140, wbregs names: FAN_TEMP
#define	R_FAN           	0x00800150	// 00800140, wbregs names: FAN_CTRL
#define	R_FAN_OVW       	0x00800154	// 00800140, wbregs names: FAN_OVW, FAN_OVERRIDE
#define	R_FAN_ADDR      	0x00800158	// 00800140, wbregs names: FAN_ADDR, FAN_ADDRESS
#define	R_FAN_CKCOUNT   	0x0080015c	// 00800140, wbregs names: FANCLK, FAN_CKCOUNT
// SDIO SD Card addresses
#define	R_SDIO_CTRL     	0x00800160	// 00800160, wbregs names: SDCARD
#define	R_SDIO_DATA     	0x00800164	// 00800160, wbregs names: SDDATA
#define	R_SDIO_FIFOA    	0x00800168	// 00800160, wbregs names: SDFIFOA, SDFIF0, SDFIFA
#define	R_SDIO_FIFOB    	0x0080016c	// 00800160, wbregs names: SDFIFOB, SDFIF1, SDFIFB
#define	R_SDIO_PHY      	0x00800170	// 00800160, wbregs names: SDPHY
#define	R_BUILDTIME     	0x00800180	// 00800180, wbregs names: BUILDTIME
#define	R_GPIO          	0x00800184	// 00800184, wbregs names: GPIO, GPI, GPO
#define	R_SIREFCLK      	0x00800188	// 00800188, wbregs names: SIREFCLK
#define	R_SPIO          	0x0080018c	// 0080018c, wbregs names: SPIO
#define	R_VERSION       	0x00800190	// 00800190, wbregs names: VERSION
// FPGA CONFIG REGISTERS: 0x4e0-0x4ff
#define	R_CFG_CRC       	0x00800200	// 00800200, wbregs names: FPGACRC
#define	R_CFG_FAR       	0x00800204	// 00800200, wbregs names: FPGAFAR
#define	R_CFG_FDRI      	0x00800208	// 00800200, wbregs names: FPGAFDRI
#define	R_CFG_FDRO      	0x0080020c	// 00800200, wbregs names: FPGAFDRO
#define	R_CFG_CMD       	0x00800210	// 00800200, wbregs names: FPGACMD
#define	R_CFG_CTL0      	0x00800214	// 00800200, wbregs names: FPGACTL0
#define	R_CFG_MASK      	0x00800218	// 00800200, wbregs names: FPGAMASK
#define	R_CFG_STAT      	0x0080021c	// 00800200, wbregs names: FPGASTAT
#define	R_CFG_LOUT      	0x00800220	// 00800200, wbregs names: FPGALOUT
#define	R_CFG_COR0      	0x00800224	// 00800200, wbregs names: FPGACOR0
#define	R_CFG_MFWR      	0x00800228	// 00800200, wbregs names: FPGAMFWR
#define	R_CFG_CBC       	0x0080022c	// 00800200, wbregs names: FPGACBC
#define	R_CFG_IDCODE    	0x00800230	// 00800200, wbregs names: FPGAIDCODE
#define	R_CFG_AXSS      	0x00800234	// 00800200, wbregs names: FPGAAXSS
#define	R_CFG_COR1      	0x00800238	// 00800200, wbregs names: FPGACOR1
#define	R_CFG_WBSTAR    	0x00800240	// 00800200, wbregs names: WBSTAR
#define	R_CFG_TIMER     	0x00800244	// 00800200, wbregs names: CFGTIMER
#define	R_CFG_BOOTSTS   	0x00800258	// 00800200, wbregs names: BOOTSTS
#define	R_CFG_CTL1      	0x00800260	// 00800200, wbregs names: FPGACTL1
#define	R_CFG_BSPI      	0x0080027c	// 00800200, wbregs names: FPGABSPI
