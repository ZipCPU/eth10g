...
//
// hdmiclrscope scope
#define	R_HDMICLRSCOPE  	0x00040000	// 00040000, wbregs names: HDMICLRSCOPE
#define	R_HDMICLRSCOPED 	0x00040004	// 00040000, wbregs names: HDMICLRSCOPED
...
#define	R_I2CCPU_ADDR   	0x00040a08	// 00040a00, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT	0x00040a0c	// 00040a00, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA        	0x00040a40	// 00040a40, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR   	0x00040a44	// 00040a40, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE   	0x00040a48	// 00040a40, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN    	0x00040a4c	// 00040a40, wbregs names: I2CDMALEN
#define	R_RXNETCK0      	0x00040a80	// 00040a80, wbregs names: RXNETCLK0, RXNETCK0
#define	R_RXNETCK1      	0x00040a84	// 00040a80, wbregs names: RXNETCLK1, RXNETCK1
#define	R_RXNETCK2      	0x00040a88	// 00040a80, wbregs names: RXNETCLK2, RXNETCK2
#define	R_RXNETCK3      	0x00040a8c	// 00040a80, wbregs names: RXNETCLK3, RXNETCK3
#define	R_TXNETCLK      	0x00040a90	// 00040a80, wbregs names: TXNETCLK
#define	R_BUILDTIME     	0x00040ac0	// 00040ac0, wbregs names: BUILDTIME
#define	R_GPIO          	0x00040ac4	// 00040ac4, wbregs names: GPIO, GPI, GPO
#define	R_NETDBG        	0x00040ac8	// 00040ac8, wbregs names: NETDBG
#define	R_NETLOCK       	0x00040acc	// 00040acc, wbregs names: NETLOCK
#define	R_SICLKFREQ     	0x00040ad0	// 00040ad0, wbregs names: SICLKFREQcreate_clock, -period, 5.2, -name, SIREF, -waveform, {0.0, 2.6, }, -add, [get_ports, i_clk_si_p]
#define	R_SIREFCLK      	0x00040ad4	// 00040ad4, wbregs names: SIREFCLK
#define	R_SIREFFREQ     	0x00040ad8	// 00040ad8, wbregs names: SIREFFREQ
#define	R_SPIO          	0x00040adc	// 00040adc, wbregs names: SPIO
#define	R_VERSION       	0x00040ae0	// 00040ae0, wbregs names: VERSION
