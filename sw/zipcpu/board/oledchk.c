...
int gen_message(unsigned msg) {
	...
	case 0: fb_font = shortfontp;
		...
		oled_write(sbuf);
		break;
	case 1:	oled_write("HEY ALEX!");
		break;
	case 2:	oled_write("Yoohoo!");
		break;
	case 3:	oled_write("Is anyone home?");
		break;
	case 4: fb_font = shortfontp;
		oled_write("Parlez vous francais");
		break;
	case 5:
	...
	case 6:
		...
		oled_write("pixel?");	
		break;
	case 7:	oled_write("What\'s up doc?");			// 110
		break;
	...
	case 9:	oled_write("Is that a");			//
		...
		break;
	case 10:	oled_write("Wipeout!");
		break;
	case 11:	oled_write("I\'m such a genius!");	// 113
		break;
	case 12:	oled_write("Doh!");			// 103?
		break;
	case 13:
	...
	case 14:
		...
		oled_write("quarters!");
		break;
	case 15:	oled_write("You rang?");		// 110
		break;
	case 16:	oled_write("I\'ll be back");		// 56,2 ??
		break;
	case 17:	oled_write("Clear the bridge");		// 120
		break;
	case 18:
	...
	case 19:
		...
		break;
	case 20:	oled_write("Fascinating");		// 103
		break;
	case 21:
	...
	case 22:
		...
		oled_write("Yes, my lord");
		break;
	case 23:	oled_write("Hey, hey, hey!");		// 94
		break;
	case 24:
	...
	case 26:
		...
		break;
	case 27:	oled_write("Nevermind!");	// 74
		break;
	case 28:
	...
	case 31:	oled_write("That's all folks!");	// 124
		break;
	default: break;
	} oled_flush();
}
