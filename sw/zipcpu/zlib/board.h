...
#define	SDIO_CMD		0x000040
#define	SDIO_ACMD		(0x040+55) // CMD55
#define	SDIO_FIFO_OP	0x000800	// Read only
#define	SDIO_WRITEOP	0x000c00	// Write to the FIFO
#define	SDIO_ALTFIFO	0x001000
// #define	SDIO_DMA	0x002000
#define	SDIO_BUSY		0x004000
#define	SDIO_ERROR		0x008000
#define	SDIO_CLEARERR	0x008000
// #define	SDIO_CRCERR	0x020000
// #define	SDIO_FRAMERR	0x030000
// #define	SDIO_REMOVED	0x040000
// #define	SDIO_PRESENTN	0x080000
// #define	SDIO_RESET		0x100000	// Read only
// #define	SDIO_WATCHDOG	0x200000	// Read only
#define	SDIO_GO_IDLE	((SDIO_CLEARERR|SDIO_CMD)+0)
#define	SDIO_READ_SECTOR	((SDIO_CMD|SDIO_CLEARERR|SDIO_FIFO_OP)+17)
#define	SDIO_WRITE_SECTOR	((SDIO_CMD|SDIO_CLEARERR|SDIO_WRITEOP)+24)
...
static volatile WBSCOPE *const _i2cscope = ((WBSCOPE *)0x00800080);
#endif	// I2CSCOPE_SCOPC
#ifdef	SIREFCLK_ACCESS
#define	_BOARD_HAS_SIREFCLK
static volatile unsigned *const _sirefclk = ((unsigned *)0x00800188);
#endif	// SIREFCLK_ACCESS
#ifdef	SMISCOPE_SCOPC
#define	_BOARD_HAS_SMISCOPE
static volatile WBSCOPE *const _scope_smi = ((WBSCOPE *)0x008000a0);
#endif	// SMISCOPE_SCOPC
#ifdef	SPIO_ACCESS
#define	_BOARD_HAS_SPIO
static volatile unsigned *const _spio = ((unsigned *)0x0080018c);
#endif	// SPIO_ACCESS
#ifdef	GPIO_ACCESS
#define	_BOARD_HAS_GPIO
static volatile unsigned *const _gpio = ((unsigned *)0x00800184);
#endif	// GPIO_ACCESS
...
static volatile unsigned *const _version = ((unsigned *)0x00800190);
#endif	// VERSION_ACCESS
#define	_BOARD_HAS_BUILDTIME
static volatile unsigned *const _buildtime = ((unsigned *)0x00800180);
#ifdef	FANSCOPE_SCOPC
#define	_BOARD_HAS_FANSCOPE
static volatile WBSCOPE *const _fanscope = ((WBSCOPE *)0x00800040);
#endif	// FANSCOPE_SCOPC
#ifdef	SDIO_ACCESS
#define	_BOARD_HAS_SDIO
static volatile SDIO *const _sdcard = ((SDIO *)0x00800160);
#endif	// SDIO_ACCESS
#ifdef	FLASH_ACCESS
...
static volatile I2CCPU *const _i2c=((I2CCPU *)0x008000e0);
#endif	// I2CCPU_ACCESS
#ifdef	FAN_ACCESS
#define	_BOARD_HAS_FAN
static volatile FAN *const _fan=((FAN *)0x00800140);
#endif	// FAN_ACCESS
#ifdef	CFGSCOPE_SCOPE
#define	_BOARD_HAS_CFGSCOPE
static volatile WBSCOPE *const _cfgscope = ((WBSCOPE *)0x00800020);
#endif	// CFGSCOPE_SCOPE
#ifdef	I2CDMA_ACCESS
#define	_BOARD_HAS_I2CDMA
static volatile I2CDMA *const _i2cdma=((I2CDMA *)0x00800100);
#endif	// I2CDMA_ACCESS
#ifdef	BKRAM_ACCESS
...
static volatile CONSOLE *const _uart = ((CONSOLE *)0x00800120);
#endif	// BUSCONSOLE_ACCESS
#ifdef	FLASHSCOPE_SCOPC
#define	_BOARD_HAS_FLASHSCOPE
static volatile WBSCOPE *const _flashdbg = ((WBSCOPE *)0x00800060);
#endif	// FLASHSCOPE_SCOPC
#ifdef	SDIOSCOPE_SCOPC
#define	_BOARD_HAS_SDIOSCOPE
static volatile WBSCOPE *const _sdioscope = ((WBSCOPE *)0x008000c0);
...
#define	SYSPIC_FLASHDBG	SYSPIC(10)
// PIC: altpic
...
#define	ALTPIC_I2CSCOPE	ALTPIC(8)
#define	ALTPIC_SMISCOPE	ALTPIC(9)
#define	ALTPIC_GPIO	ALTPIC(10)
#define	ALTPIC_FANSCOPE	ALTPIC(11)
#define	ALTPIC_UARTTX	ALTPIC(12)
#define	ALTPIC_UARTRX	ALTPIC(13)
#define	ALTPIC_SDIOSCOPE	ALTPIC(14)
#endif	// BOARD_H
