...
static volatile unsigned *const _netclk = ((unsigned *)0x020002a0);
#endif	// NETCLK_ACCESS
#ifdef	REFCLKCOUNTER_ACCESS
#define	_BOARD_HAS_REFCLKCOUNTER
static volatile unsigned *const _sirefclkcounter = ((unsigned *)0x020002e4);
#endif	// REFCLKCOUNTER_ACCESS
#ifdef	FAN_ACCESS
#define	_BOARD_HAS_FAN
static volatile FAN *const _fan=((FAN *)0x02000140);
#endif	// FAN_ACCESS
#ifdef	I2CCPU_ACCESS
#define	_BOARD_HAS_I2CCPU
static volatile I2CCPU *const _i2c=((I2CCPU *)0x02000280);
#endif	// I2CCPU_ACCESS
#ifdef	I2CDMA_ACCESS
#define	_BOARD_HAS_I2CDMA
static volatile I2CDMA *const _i2cdma=((I2CDMA *)0x02000290);
#endif	// I2CDMA_ACCESS
#ifdef	EMMCSCOPE_SCOPC
#define	_BOARD_HAS_EMMCSCOPE
static volatile WBSCOPE *const _emmcscope = ((WBSCOPE *)0x02000020);
#endif	// EMMCSCOPE_SCOPC
#ifdef	SDIOSCOPE_SCOPC
#define	_BOARD_HAS_SDIOSCOPE
static volatile WBSCOPE *const _sdioscope = ((WBSCOPE *)0x020000e0);
#endif	// SDIOSCOPE_SCOPC
#define	_BOARD_HAS_NETLOCK
static volatile unsigned *const _netlock = ((unsigned *)0x020002cc);
#ifdef	GATESCOPE_SCOPC
#define	_BOARD_HAS_GATESCOPE
static volatile WBSCOPE *const _gatescope = ((WBSCOPE *)0x02000060);
#endif	// GATESCOPE_SCOPC
#ifdef	I2CSCOPE_SCOPC
#define	_BOARD_HAS_I2CSCOPE
static volatile WBSCOPE *const _i2cscope = ((WBSCOPE *)0x02000080);
#endif	// I2CSCOPE_SCOPC
#ifdef	ROUTESCOPE_SCOPC
#define	_BOARD_HAS_ROUTESCOPE
static volatile WBSCOPE *const _routescope = ((WBSCOPE *)0x020000c0);
#endif	// ROUTESCOPE_SCOPC
#ifdef	SPIO_ACCESS
#define	_BOARD_HAS_SPIO
static volatile unsigned *const _spio = ((unsigned *)0x020002e8);
#endif	// SPIO_ACCESS
#ifdef	NETSCOPE_SCOPC
#define	_BOARD_HAS_NETSCOPE
static volatile WBSCOPE *const _netscope = ((WBSCOPE *)0x020000a0);
...
static volatile unsigned *const _rtccount = ((unsigned *)0x020002d8);
#ifdef	PWRCOUNT_ACCESS
static volatile unsigned *const _pwrcount = ((unsigned *)0x020002d4);
#endif	// PWRCOUNT_ACCESS
#ifdef	SIREFCLK_ACCESS
#define	_BOARD_HAS_SIREFCLK
static volatile unsigned *const _sirefclk = ((unsigned *)0x020002e0);
#endif	// SIREFCLK_ACCESS
#ifdef	DDR3_PHY_ACCESS
#define	_BOARD_HAS_DDR3_PHY
static volatile DDR3_PHY *const _ddr3_phy = ((DDR3_PHY *)0x02000400);
...
static volatile unsigned *const _version = ((unsigned *)0x020002ec);
#endif	// VERSION_ACCESS
#ifdef	CPUNET_ACCESS
#define	_BOARD_HAS_CPUNET
static volatile CPUNET *const _cpunet=((CPUNET *)0x02000200);
#endif	// CPUNET_ACCESS
#ifdef	SICLK
#define	_BOARD_HAS_SICLKCOUNTER
static volatile unsigned *const _siclk = ((unsigned *)0x020002dc);
#endif	// SICLK
#define	_BOARD_HAS_BUILDTIME
static volatile unsigned *const _buildtime = ((unsigned *)0x020002c0);
#ifdef	FLASHSCOPE_SCOPC
#define	_BOARD_HAS_FLASHSCOPE
static volatile WBSCOPE *const _flashdbg = ((WBSCOPE *)0x02000040);
#endif	// FLASHSCOPE_SCOPC
#ifdef	BUSCONSOLE_ACCESS
#define	_BOARD_HAS_BUSCONSOLE
static volatile CONSOLE *const _uart = ((CONSOLE *)0x02000100);
...
static volatile unsigned *const _gpio = ((unsigned *)0x020002c4);
#endif	// GPIO_ACCESS
#ifdef	SDIO_ACCESS
#define	_BOARD_HAS_SDIO
static volatile struct SDIO_S *const _sdio = ((struct SDIO_S *)0x02000160);
#endif	// SDIO_ACCESS
#ifdef	EMMC_ACCESS
#define	_BOARD_HAS_EMMC
static volatile struct EMMC_S *const _emmc = ((struct EMMC_S *)0x02000120);
#endif	// EMMC_ACCESS
#ifdef	NETSTAT_ACCESS
static NETSTAT *const _netstats = ((NETSTAT *)0x02000600);
...
static volatile unsigned *const _netreset = ((unsigned *)0x020002d0);
#endif	// NETRESET_ACCESS
#ifdef	ETH_ROUTER
static struct ROUTER_S *const _gnet = ((struct ROUTER_S *)0x02000300);
#endif	// ETH_ROUTER
//
